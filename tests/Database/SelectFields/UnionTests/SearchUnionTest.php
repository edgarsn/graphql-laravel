...
class SearchUnionTest extends TestCaseDatabase
{
    ...
    public function test_customQueryDoesntWorkWhenQueryUsingUnionType(): void
    {
        /** @var Post $post */
...
GRAQPHQL;
    ...
    public function test_customQueryWorksWhenQueryTypeIsNotUnionType(): void
    {
        /** @var Post $post */
        $post = factory(Post::class)->create();
        /** @var Comment $comment1 */
